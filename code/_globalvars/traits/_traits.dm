...
GLOBAL_LIST_INIT(traits_by_type, list(
	...
	/mob = list(
		...
		"TRAIT_BRUISER" = TRAIT_BRUISER, // DARKPACK EDIT ADD - MERITS/FLAWS
		...
		"TRAIT_ENCHANTING_VOICE" = TRAIT_ENCHANTING_VOICE, // DARKPACK EDIT ADD - MERITS/FLAWS
		...
		"TRAIT_GRAVE_SMELL" = TRAIT_GRAVE_SMELL, // DARKPACK EDIT ADD - MERITS/FLAWS
		"TRAIT_GHOST_VISION" = TRAIT_GHOST_VISION, // DARKPACK EDIT ADD - POWERS - (Necromancy)
		"TRAIT_GLOWING_EYES" = TRAIT_GLOWING_EYES, // DARKPACK EDIT ADD - MERITS/FLAWS
		...
		"TRAIT_LIGHT_WEAKNESS_WEAK" = TRAIT_LIGHT_WEAKNESS_WEAK, // DARKPACK EDIT ADD - MERITS/FLAWS
